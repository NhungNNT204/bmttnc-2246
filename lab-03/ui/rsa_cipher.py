...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_gen_keys.setGeometry(QtCore.QRect(760, 160, 111, 23))
        self.btn_gen_keys.setObjectName("btn_gen_keys")
        self.btn_sign = QtWidgets.QPushButton(self.centralwidget)
        self.btn_sign.setGeometry(QtCore.QRect(830, 520, 75, 23))
        self.btn_sign.setObjectName("btn_sign")
        self.btn_verify = QtWidgets.QPushButton(self.centralwidget)
        self.btn_verify.setGeometry(QtCore.QRect(1130, 520, 75, 23))
        self.btn_verify.setObjectName("btn_verify")
        self.txt_sign = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_sign.setGeometry(QtCore.QRect(830, 420, 381, 91))
        ...
        self.txt_info.setGeometry(QtCore.QRect(830, 240, 381, 91))
